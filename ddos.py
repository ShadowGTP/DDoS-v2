...
_     ____        ___             _              _ 
 | |   |___ \      / _ \           | |            | |
 | |__   __) |_ __| | | |  ______  | |_ ___   ___ | |
 | '_ \ |__ <| '__| | | | |______| | __/ _ \ / _ \| |
 | | | |___) | |  | |_| |          | || (_) | (_) | |
 |_| |_|____/|_|   \___/            \__\___/ \___/|_|
...
def clone():
    ...
    try:
        ...
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/rdavydov/proxy-list/main/proxies/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
    ...
    try:
        ...
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/manuGMG/proxy-365/main/SOCKS5.txt")
        f.write(r.content)
    except:
        pass
    try:
    ...
    try:
        ...
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/RX4096/proxy-list/main/online/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
